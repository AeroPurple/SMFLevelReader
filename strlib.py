...
fancyVersion=(
 ...
 f"            {colorscheme.ANSICodes[useANSI][19]}║ ║   ║ ║ ║{colorScheme['default']}\n"
 f"        Ver {colorscheme.ANSICodes[useANSI][19]}╙─╜ . ╨ ╙─╜ ß{colorScheme['default']}\n"
"\n"
...
f"{colorscheme.ANSICodes[useANSI][8]}└{colorscheme.ANSICodes[useANSI][16]}█{colorscheme.ANSICodes[useANSI][8]}┌┘"                                        # T row 2
f"{colorscheme.ANSICodes[useANSI][9]}└{colorscheme.ANSICodes[useANSI][17]}█{colorscheme.ANSICodes[useANSI][9]}┌┘"                                        # T row 2
